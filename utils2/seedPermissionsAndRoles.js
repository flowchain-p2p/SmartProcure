...
const roleDefinitions = [  {
    ...
    permissions: ['pr.create', 'pr.view', 'pr.edit', 'pr.submit', 'pr.approve', 'pr.reject', 'pr.cancel', 'rfq.view', 'po.view'],
  },
  {
    name: 'CostCenterHead',
    ...
    permissions: ['pr.approve', 'pr.reject', 'pr.view', 'pr.create', 'pr.edit', 'pr.submit', 'pr.cancel', 'rfq.view', 'po.view'],
  },
  {
    name: 'Approver',
    code: 'approver',
    ...
    inheritsFrom: 'requester',
    permissions: ['pr.create', 'pr.view', 'pr.edit', 'pr.submit', 'pr.approve', 'pr.reject', 'pr.cancel', 'po.view', 'po.approve', 'rfq.view'],   
  ...
  },
  {
    ...
    permissions: [
      // PR Management - adding all PR permissions
      'pr.create', 'pr.view', 'pr.edit', 'pr.submit', 'pr.approve', 'pr.reject', 'pr.cancel',
      // Existing permissions
      'po.view', 'budget.view', 'budget.check', 
