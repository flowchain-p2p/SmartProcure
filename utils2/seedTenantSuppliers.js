...
const seedTenantSuppliers = async () => {
  try {
    console.log(`Starting ${tenantName} suppliers seeding...`);
    ...
    const suppliers = [
      ...
      },
      {
        vendor: {
          ...
          email: `supplier3@${tenantSlug}.com`,
          phone: "9876543212",
          address: {
      ...
      },
      {
        vendor: {
          ...
          email: `supplier4@${tenantSlug}.com`,
          phone: "9876543213",
          address: {
      ...
      },
      {
        vendor: {
          ...
          email: `supplier5@${tenantSlug}.com`,
          phone: "9876543214",
          address: {
      ...
      },
      {
        vendor: {
          ...
          email: `supplier6@${tenantSlug}.com`,
          phone: "9876543215",
          address: {
      ...
      },
      {
        vendor: {
          ...
          email: `supplier7@${tenantSlug}.com`,
          phone: "9876543216",
          address: {
      ...
      },
      {
        vendor: {
          ...
          email: `supplier8@${tenantSlug}.com`,
          phone: "9876543217",
          address: {
      ...
      },
      {
        vendor: {
          ...
          email: `supplier9@${tenantSlug}.com`,
          phone: "9876543218",
          address: {
      ...
      },
      {
        vendor: {
          ...
          email: `supplier10@${tenantSlug}.com`,
          phone: "9876543219",
          address: {
    ...
    for (const supplier of suppliers) {
      await User.deleteOne({ email: supplier.user.email, tenantId: tenant._id });
      await Vendor.deleteOne({ email: supplier.vendor.email, tenantId: tenant._id });
    }
    ...
    console.error(`Error seeding ${tenantName} suppliers:`, error);
  } finally {
